...
class CitiesController extends Controller {
	...
	public function create()
	{
		...
		return view('backend.cities.create', compact('model', 'city'));
	}
	...
	public function store(Request $request)
	{
        ...
        if (method_exists($city, 'phones')) {
            foreach ($request->phones as $phone) {
                $city->phones()->create(['phone' => $phone]);
            }
        }
	...
	public function edit($id)
	{
		...
		return view('backend.cities.edit', compact('model', 'city'));
	}
	...
	public function batchedit()
	{
	    ...
	    return view('backend.cities.batchedit', compact('cities'));
	}
    ...
    {
        $modelId   = $id;
        $class     = 'App\City'; // just to support polymorphic nesting
