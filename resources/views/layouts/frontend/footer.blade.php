  ...
  <div class="container pt-70 pb-70">
    <div class="row">
      <div class="col-md-8 col-md-offset-2 text-center wow fadeInUp animation-delay1">
        <a class="text-white font-playball text-theme-colored font-32" href="#">EGY <i class="fa fa-heart-o font-25"></i> POVA</a>
        <h6>{{__('Copyright')}} &copy; 2017 EGY POVA{{__(',')}} {{__('All Rights Reserved.')}}</h6>
