...
<div class='bio-row{{ $errors->has('nameAr') ? ' has-error' : '' }}'>
	...
	{!! Form::text('nameAr', optional(json_decode($city->name))->nameAr, array('class' => 'form-control', 'required' => 'required')) !!}
...
<div class='bio-row{{ $errors->has('nameEn') ? ' has-error' : '' }}'>
	...
	{!! Form::text('nameEn', optional(json_decode($city->name))->nameEn, array('class' => 'form-control', 'required' => 'required')) !!}
